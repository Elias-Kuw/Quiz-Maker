...
<body>
    ...
    if ($result->rowCount() > 0) {
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
          ...
          $questionsQuery = "SELECT question FROM questions1 WHERE quizid = " . $quizID .
                            " UNION ALL " .
                            "SELECT question FROM questions2 WHERE quizid = " . $quizID .
                            " UNION ALL " .
          ...
          if ($questionCount > 0) {
              ...
              <div class="Cards">
                  ...
                  <img src="image\operations.jpg" alt="quiz image">
                      <hr/>
                      <h4><span></span><?php echo $title; ?></h4>
                      ...
                      <a class="cardB" href="quiz.php?quizID=<?php echo $quizID; ?>">Enter</a>
                  </div>
              </div>
              <?php
          }
...
<body>
    ...
    <main class="notLoginMain">
      <h2> Please login or register to see the quizes available</h2>
    </main>
